...
@app.command()
def run(
    config_path: Path = typer.Option(..., "--config", "-c", help="Path to the YAML configuration file.")
) -> None:
    ...
    try:
        ...
        console.print(f"Successfully loaded configuration from [bold green]{config_path}[/bold green]")
