...
├── dev_documents/              # [Documentation] Context source for AI
│   ├── templates/              # [Templates] Agent instructions and .env.example
...
│   └── CYCLE02/...
├── dev_src/                    # [Agent Core] AC-CDD Internal Logic
│   └── ac_cdd_core/
├── src/                        # [User Space] Product Code
